...
![Word cloud for `description`](fig-01.png){#fig-01}

@fig-01 is the result of:
...
Also, @fig-01 enabled the spot of phenomena in the following order:
...
@fig-02 summarises such apparitions as defined or not defined:
...
haunted_places |>
  ...
  labs(
    ...
    blob/master/data/2023/2023-10-10/readme.md"
  ) +
  dark_theme_gray() +
  theme(
...
@fig-03 shows the top 30 haunted locations by type across the US:
...
#| echo: true
#| label: fig-03
#| fig-cap: "Top 30 haunted locations by type accross the US arranged in descending order"
#| warning: false
...
@fig-04 shows ghostly apparitions by region for both defined and not-defined categories
